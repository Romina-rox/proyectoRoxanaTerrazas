                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{url('/admin/equipos/'.$equipo->id.'/edit')}}" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                        <form action="{{url('/admin/equipos',$equipo->id)}}" method="post"
                                              onclick="preguntar{{$equipo->id}}(event)" id="miFormulario{{$equipo->id}}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
                                        </form>
                                        <script>
                                            function preguntar{{$equipo->id}}(event) {
                                                ...
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                        var form = $('#miFormulario{{$equipo->id}}');
                                                        form.submit();
                                                    }
                                                });
                                            }
